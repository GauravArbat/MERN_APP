...
import logo1 from '../assest/logo122.jpg'
  ...
  return (
    <header className='h-16 shadow-md bg-white fixed w-full z-40'>
      <div className=' h-full container mx-auto flex items-center px-4 justify-between'>
            <div className=''>
                <Link to={"/"}>
                <div className='w-[51px] h-auto mx-auto md:w-[247px] md:h-[41px]'>
                        <img style={{width:"96px",height:"40px"}} src={logo1} alt='login icons'/>
                    </div>
                </Link>
            </div>
